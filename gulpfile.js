...
gulp.task('css-libs', function() {
	return gulp.src('app/libs/bootstrap/dist/css/bootstrap.min.css') // Выбираем файл для минификации
...
gulp.task('watch', ['browser-sync','sass', 'css-libs', 'scripts'], function() {
	...
	gulp.watch(['app/js/main.js', 'app/libs/**/*.js'], browserSync.reload);   // Наблюдение за JS файлами в папке js
});
